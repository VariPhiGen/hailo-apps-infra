...
def SOURCE_PIPELINE(video_source, video_width=640, video_height=640,
    ...
    source_pipeline = (
        ...
        f'{QUEUE(name=f"{name}_original_frame_q")} ! '
        f'identity name=original_frame_identity ! '
...
def TRACKER_PIPELINE(class_id, kalman_dist_thr=0.8, iou_thr=0.9, init_iou_thr=0.7, keep_new_frames=2, keep_tracked_frames=1, keep_lost_frames=2, keep_past_metadata=False, qos=False, name='hailo_tracker'):
    """
